    ...
    <body class="mb-48">
        <nav class="flex justify-between items-center pt-5 m-7">
            ...
            <ul class="flex space-x-6 mr-6 text-lg">
                ...
                <li>
                    <a href="{{route('listing.create')}}" class="hover:text-green-500"
                        ><i class="fa-solid fa-gear"></i>
                        Add Tution Listing</a
                    >
                </li>
                <li>
                    <a href="{{route('listing.manage')}}" class="hover:text-green-500"
                        ><i class="fa-solid fa-gear"></i>
                        Manage Tution Listing</a
                    >
                </li>
                <li>
                ...
                <li>
                    <a href="{{route('user.create')}}" class="hover:text-green-500"
