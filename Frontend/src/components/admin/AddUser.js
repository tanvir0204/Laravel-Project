...
export default function AddUser(props){
    ...
    const submitForm = () => {
        /* API CALL */
        http.post('/add/user', {name:name, email:email, password:password}).then((res) => {
            navigate('/');
        })
    }
    ...
    return (
        <div className="row justify-content-center pt-4">
            <Link className="inline-block text-success ml-4 mb-4 text-decoration-none" to="/users/view">Back </Link>

            <div className="row justify-content-center">
                <div className="col-sm-6">
                <div className="card p-4">
                <h2 className="align-items-center text-center text-success ">Add User</h2>
