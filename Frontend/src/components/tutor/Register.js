...
export default function Register(){
    ...
    const submitForm = () => {
        /* API CALL */
        http.post('/tutor/register', {name:name, email:email, password:password}).then((res) => {
            navigate('/login');
        })
    }
    ...
    return(
        <div className="row justify-content-center pt-5">
            <div className="col-sm-6">
                ...
                <h2 className="align-items-center text-center text-primary ">Register as a Tutor</h2>
                <p className="align-items-center text-center text-primary ">Register to find a Tuition</p>
